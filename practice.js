...
function addTen(number){
  var newArr = []
  number.forEach(e => newArr.push(Number(e)+10));
  return newArr;
}
...
*/
var iCahlan = devMountainEmployees.indexOf(cahlan);
if(iCahlan !== -1){
  devMountainEmployees.splice(iCahlan, 1);
}
...
var user2 = {
	name: 'Tylersasd McGinnis',
	email: 'tylermcdassginnis33@gmail.com',
	password: 'iLoveJavaScript',
	username: 'infiniteLoop'
};
var user3 = {
	name: 'Tylersasd McGinnis',
	email: 'tylermasdcgidnnis33@gmail.com',
	password: 'iLoveJavaScript',
	username: 'infiniteLoop'
};
var user4 = {
	name: 'Tylesrsa McGinnis',
	email: 'tylerasdmcgindnis33@gmail.com',
	password: 'iLoveJavaScript',
	username: 'infiniteLoop'
};
